...
_KEYPAD:
	...
	.DB  0xB,0x0,0xC,0x0,0xD,0x0,0xE,0x0
	.DB  0xF,0x0,0x10,0x0,0x11,0x0,0x12,0x0
	.DB  0x15,0x0,0x16,0x0,0x17,0x0,0x18,0x0
	.DB  0x19,0x0,0x1A,0x0,0x1B,0x0,0x1C,0x0
	.DB  0x1F,0x0,0x20,0x0,0x21,0x0,0x22,0x0
	.DB  0x23,0x0,0x24,0x0,0x25,0x0,0x26,0x0
_tbl10_G100:
...
; 0000 0068             key_pressed=KEYPAD[cur_row][cur_col];                 //else check another cols
	...
	LDI  R31,0
	RCALL __LSLW4
	SUBI R30,LOW(-_KEYPAD*2)
	SBCI R31,HIGH(-_KEYPAD*2)
	MOVW R26,R30
	MOV  R30,R19
	LDI  R31,0
	LSL  R30
